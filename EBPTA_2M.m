...
%
 ...
 V=V'; 
    ...
    if V(5,2)==0
     ...
     y6 = (V(6,3)/V(6,2))-((V(6,1)*x1)/V(6,2));
     plot(x1,y5,'Color','y')
     hold on
     if V(7,2)==0
         V(7,2)=V(7,2)+0.0001;
     end
     y7 = (V(7,3)/V(7,2))-((V(7,1)*x1)/V(7,2));
     plot(x1,y5,'Color','y')
     hold on
     if V(8,2)==0
         V(8,2)=V(8,2)+0.0001;
     end
     y8 = (V(8,3)/V(8,2))-((V(8,1)*x1)/V(8,2));
     plot(x1,y5,'Color','y')
     hold on
     if V(9,2)==0
         V(9,2)=V(9,2)+0.0001;
     end
     y9 = V(9,3)/V(9,2)-((V(9,1)*x1)/V(9,2));
     plot(x1,y5,'Color','y')
     hold on
    
      if V(10,2)==0
         V(10,2)=V(10,2)+0.0001;
     end
     y10 = V(10,3)/V(10,2))-((V(10,1)*x1)/V(10,2));
     plot(x1,y5,'Color','y')
     hold on
figure (2)
